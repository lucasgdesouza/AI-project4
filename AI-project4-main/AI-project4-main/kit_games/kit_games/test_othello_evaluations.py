...
from advsearch.aggressive_pointer.othello_minimax_count import evaluate_count 
from advsearch.aggressive_pointer.othello_minimax_mask import evaluate_mask  
